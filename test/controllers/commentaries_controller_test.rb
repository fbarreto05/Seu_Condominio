...
class CommentariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commentary" do
    assert_difference("Commentary.count") do
      post commentaries_url, params: { commentary: { date: @commentary.date, name: @commentary.name, task_id: @commentary.task_id, text: @commentary.text } }
    end
  ...
  test "should update commentary" do
    patch commentary_url(@commentary), params: { commentary: { date: @commentary.date, name: @commentary.name, task_id: @commentary.task_id, text: @commentary.text } }
